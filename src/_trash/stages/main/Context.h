...
namespace Cellwars
{
    ...
    {
    public:
        Player* RequestPlayers () const override
        {
            return players;
        }

        void DonePlayers () const override
        {
        }

        unsigned GetPlayerCnt () const override
        {
            return num_players;
        }

        Blob* RequestBlobs () const override
        {
            return blobs;
        }

        void DoneBlobs () const override
        {
        }

        unsigned GetBlobCnt () const override
        {
            return num_blobs;
        }

        const ClipWindow& GetClipWindow () const override
        {
            return clip_w;
        }
